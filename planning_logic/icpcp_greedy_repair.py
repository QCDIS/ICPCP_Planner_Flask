...
def graphCheckEST():
    for n in range(0, number_of_nodes):
        ...
        if maxest > deadline:
            ...
            print("\n**** Wrong EST: " + "EST(" + G.node[n]["name"] + ")=" + str(
                G.node[n]["EST"]) + "> deadline=" + str(deadline))
                ...
                if prop_cas > 0:
                    ...
                    if p_cas == -1:
                        if verbose > 0:
                            ...
                            print("new_inst_cost=" + str(new_inst_cost), "<", "best_inst_cost=" + str(
                                best_inst_cost) + "?:", end=' ')
                        ...
                        if verbose > 0:
                            print("check extended instance", new_inst, "with prop_cas=" + str(prop_cas))
                            print("new_inst_cost=" + str(new_inst_cost), "<=", "(inst_cost=" + str(
                                inst_cost) + "+p_cost=" + str(p_cost) + ")?:", end=' ')
...
def printResult():
    ...
    if len(instances) > 0:
        ...
        if tot_idle > 0:
            print("\nTotal cost: " + str(total_cost) + " for " + str(number_of_nodes), "nodes with tot idle=" + str(
                tot_idle))
        else:
...
def main(argv, command_line=True, graph=None, prep_prices=None, prep_deadline=None):
    ...
    if retVal == -1:
        ...
        if retVal == -1:
            ...
            print("final configuration: cost=" + str(total_cost) + "  EFT(exit)=" + str(
                G.node[(number_of_nodes - 1)]["EFT"]))
